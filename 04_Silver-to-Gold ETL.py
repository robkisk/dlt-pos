...
# T pipelines.trigger.interval = 5 minute;

# EATE LIVE TABLE inventory_current
# MMENT 'calculate current inventory given the latest inventory snapshots and inventory-relevant events'
# LPROPERTIES (
#'quality'='gold'
# )
#
...
# MAGIC %md
# MAGIC Of course, we could have used Python (as we did in the *POS 03* notebook) to define this object.
# MAGIC - If we did, our implementation might look something like this:
# MAGIC
# MAGIC ```
# MAGIC
# MAGIC @dlt.table(
