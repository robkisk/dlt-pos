...
# MAGIC %md
# MAGIC This notebook is to introduce the Point-of-Sale Streaming with Delta Live Tables solution accelerator.
...
# MAGIC %md
# MAGIC ## Structured Streaming vs. Delta Live Tables
# MAGIC
